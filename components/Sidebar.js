...
function Sidebar() {
  ...
  return (
    <div className="space-y-2 min-w-max max-w-lg">
      {/* Top */}
      <div className="bg-[#F0F8FF] dark:bg-[#1D2226] rounded-lg overflow-hidden relative flex flex-col items-center text-center border border-gray-300 dark:border-none">
        ...
        <div className="hidden md:inline text-left dark:text-white/75 text-sm">
          ...
          <div className="sidebarButton flex items-center space-x-1.5">
            ...
            <h4 className="dark:text-white font-medium">My Profile</h4>
          </div>
        </div>
      </div>
      {/* Bottom */}
      <div className="hidden md:flex bg-[#F0F8FF] dark:bg-[#1D2226] text-black/70 dark:text-white/75 rounded-lg overflow-hidden flex-col space-y-2 pt-2.5 sticky top-20 border border-gray-300 dark:border-none">
